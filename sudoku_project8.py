...
while(1):
	...
	if(len(rects)):
		...
		if(str(max_area_ctr) != '0'):
			...
			if(approx.shape[0] == 4):
				if(abs(approx[1][0][0] - approx[0][0][0]) < abs(approx[0][0][1] - approx[1][0][1])):
